...
class ItemType
{
     ...
     *  Text. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\Keyword[] $keyword
     */
    private $keyword = [
     ...
     *  Coca-Cola
     *
     * @var \CleverIt\UBL\Invoice\RO\BrandName[] $brandName
     */
    private $brandName = [
     ...
     *  VW Beetle
     *
     * @var \CleverIt\UBL\Invoice\RO\ModelName[] $modelName
     */
    private $modelName = [
     ...
     *  Item Identification
     *
     * @var \CleverIt\UBL\Invoice\RO\BuyersItemIdentification $buyersItemIdentification
     */
     ...
     *  Item Identification
     *
     * @var \CleverIt\UBL\Invoice\RO\SellersItemIdentification $sellersItemIdentification
     */
     ...
     *  Item Identification
     *
     * @var \CleverIt\UBL\Invoice\RO\ManufacturersItemIdentification[] $manufacturersItemIdentification
     */
     ...
     *  Item Identification
     *
     * @var \CleverIt\UBL\Invoice\RO\StandardItemIdentification $standardItemIdentification
     */
     ...
     *  Item Identification
     *
     * @var \CleverIt\UBL\Invoice\RO\CatalogueItemIdentification $catalogueItemIdentification
     */
     ...
     *  Item Identification
     *
     * @var \CleverIt\UBL\Invoice\RO\AdditionalItemIdentification[] $additionalItemIdentification
     */
     ...
     *  Document Reference
     *
     * @var \CleverIt\UBL\Invoice\RO\CatalogueDocumentReference $catalogueDocumentReference
     */
     ...
     *  Document Reference
     *
     * @var \CleverIt\UBL\Invoice\RO\ItemSpecificationDocumentReference[] $itemSpecificationDocumentReference
     */
     ...
     *  Country
     *
     * @var \CleverIt\UBL\Invoice\RO\OriginCountry $originCountry
     */
     ...
     *  Commodity Classification
     *
     * @var \CleverIt\UBL\Invoice\RO\CommodityClassification[] $commodityClassification
     */
     ...
     *  Transaction Conditions
     *
     * @var \CleverIt\UBL\Invoice\RO\TransactionConditions[] $transactionConditions
     */
     ...
     *  Hazardous Item
     *
     * @var \CleverIt\UBL\Invoice\RO\HazardousItem[] $hazardousItem
     */
     ...
     *  Tax Category
     *
     * @var \CleverIt\UBL\Invoice\RO\ClassifiedTaxCategory[] $classifiedTaxCategory
     */
     ...
     *  Party
     *
     * @var \CleverIt\UBL\Invoice\RO\InformationContentProviderParty $informationContentProviderParty
     */
     ...
     *  Item Instance
     *
     * @var \CleverIt\UBL\Invoice\RO\ItemInstance[] $itemInstance
     */
     ...
     *  Certificate
     *
     * @var \CleverIt\UBL\Invoice\RO\Certificate[] $certificate
     */
    private $certificate = [
     ...
     *  Dimension
     *
     * @var \CleverIt\UBL\Invoice\RO\Dimension[] $dimension
     */
    private $dimension = [
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\Keyword $keyword
     */
    public function addToKeyword(\CleverIt\UBL\Invoice\RO\Keyword $keyword)
    {
     ...
     *  Text. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\Keyword[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\BrandName $brandName
     */
    public function addToBrandName(\CleverIt\UBL\Invoice\RO\BrandName $brandName)
    {
     ...
     *  Coca-Cola
     *
     * @return \CleverIt\UBL\Invoice\RO\BrandName[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\ModelName $modelName
     */
    public function addToModelName(\CleverIt\UBL\Invoice\RO\ModelName $modelName)
    {
     ...
     *  VW Beetle
     *
     * @return \CleverIt\UBL\Invoice\RO\ModelName[]
     */
     ...
     *  Item Identification
     *
     * @return \CleverIt\UBL\Invoice\RO\BuyersItemIdentification
     */
     ...
     *  Item Identification
     *
     * @param \CleverIt\UBL\Invoice\RO\BuyersItemIdentification $buyersItemIdentification
     * @return self
     */
    public function setBuyersItemIdentification(?\CleverIt\UBL\Invoice\RO\BuyersItemIdentification $buyersItemIdentification = null)
    {
     ...
     *  Item Identification
     *
     * @return \CleverIt\UBL\Invoice\RO\SellersItemIdentification
     */
     ...
     *  Item Identification
     *
     * @param \CleverIt\UBL\Invoice\RO\SellersItemIdentification $sellersItemIdentification
     * @return self
     */
    public function setSellersItemIdentification(?\CleverIt\UBL\Invoice\RO\SellersItemIdentification $sellersItemIdentification = null)
    {
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\ManufacturersItemIdentification $manufacturersItemIdentification
     */
    public function addToManufacturersItemIdentification(\CleverIt\UBL\Invoice\RO\ManufacturersItemIdentification $manufacturersItemIdentification)
    {
     ...
     *  Item Identification
     *
     * @return \CleverIt\UBL\Invoice\RO\ManufacturersItemIdentification[]
     */
     ...
     *  Item Identification
     *
     * @return \CleverIt\UBL\Invoice\RO\StandardItemIdentification
     */
     ...
     *  Item Identification
     *
     * @param \CleverIt\UBL\Invoice\RO\StandardItemIdentification $standardItemIdentification
     * @return self
     */
    public function setStandardItemIdentification(?\CleverIt\UBL\Invoice\RO\StandardItemIdentification $standardItemIdentification = null)
    {
     ...
     *  Item Identification
     *
     * @return \CleverIt\UBL\Invoice\RO\CatalogueItemIdentification
     */
     ...
     *  Item Identification
     *
     * @param \CleverIt\UBL\Invoice\RO\CatalogueItemIdentification $catalogueItemIdentification
     * @return self
     */
    public function setCatalogueItemIdentification(?\CleverIt\UBL\Invoice\RO\CatalogueItemIdentification $catalogueItemIdentification = null)
    {
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\AdditionalItemIdentification $additionalItemIdentification
     */
    public function addToAdditionalItemIdentification(\CleverIt\UBL\Invoice\RO\AdditionalItemIdentification $additionalItemIdentification)
    {
     ...
     *  Item Identification
     *
     * @return \CleverIt\UBL\Invoice\RO\AdditionalItemIdentification[]
     */
     ...
     *  Document Reference
     *
     * @return \CleverIt\UBL\Invoice\RO\CatalogueDocumentReference
     */
     ...
     *  Document Reference
     *
     * @param \CleverIt\UBL\Invoice\RO\CatalogueDocumentReference $catalogueDocumentReference
     * @return self
     */
    public function setCatalogueDocumentReference(?\CleverIt\UBL\Invoice\RO\CatalogueDocumentReference $catalogueDocumentReference = null)
    {
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\ItemSpecificationDocumentReference $itemSpecificationDocumentReference
     */
    public function addToItemSpecificationDocumentReference(\CleverIt\UBL\Invoice\RO\ItemSpecificationDocumentReference $itemSpecificationDocumentReference)
    {
     ...
     *  Document Reference
     *
     * @return \CleverIt\UBL\Invoice\RO\ItemSpecificationDocumentReference[]
     */
     ...
     *  Country
     *
     * @return \CleverIt\UBL\Invoice\RO\OriginCountry
     */
     ...
     *  Country
     *
     * @param \CleverIt\UBL\Invoice\RO\OriginCountry $originCountry
     * @return self
     */
    public function setOriginCountry(?\CleverIt\UBL\Invoice\RO\OriginCountry $originCountry = null)
    {
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\CommodityClassification $commodityClassification
     */
    public function addToCommodityClassification(\CleverIt\UBL\Invoice\RO\CommodityClassification $commodityClassification)
    {
     ...
     *  Commodity Classification
     *
     * @return \CleverIt\UBL\Invoice\RO\CommodityClassification[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\TransactionConditions $transactionConditions
     */
    public function addToTransactionConditions(\CleverIt\UBL\Invoice\RO\TransactionConditions $transactionConditions)
    {
     ...
     *  Transaction Conditions
     *
     * @return \CleverIt\UBL\Invoice\RO\TransactionConditions[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\HazardousItem $hazardousItem
     */
    public function addToHazardousItem(\CleverIt\UBL\Invoice\RO\HazardousItem $hazardousItem)
    {
     ...
     *  Hazardous Item
     *
     * @return \CleverIt\UBL\Invoice\RO\HazardousItem[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\ClassifiedTaxCategory $classifiedTaxCategory
     */
    public function addToClassifiedTaxCategory(\CleverIt\UBL\Invoice\RO\ClassifiedTaxCategory $classifiedTaxCategory)
    {
     ...
     *  Tax Category
     *
     * @return \CleverIt\UBL\Invoice\RO\ClassifiedTaxCategory[]
     */
     ...
     */
    public function addToManufacturerParty(\CleverIt\UBL\Invoice\RO\ManufacturerParty $manufacturerParty)
    {
     ...
     *  Party
     *
     * @return \CleverIt\UBL\Invoice\RO\InformationContentProviderParty
     */
     ...
     *  Party
     *
     * @param \CleverIt\UBL\Invoice\RO\InformationContentProviderParty $informationContentProviderParty
     * @return self
     */
    public function setInformationContentProviderParty(?\CleverIt\UBL\Invoice\RO\InformationContentProviderParty $informationContentProviderParty = null)
    {
     ...
     */
    public function addToOriginAddress(\CleverIt\UBL\Invoice\RO\OriginAddress $originAddress)
    {
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\ItemInstance $itemInstance
     */
    public function addToItemInstance(\CleverIt\UBL\Invoice\RO\ItemInstance $itemInstance)
    {
     ...
     *  Item Instance
     *
     * @return \CleverIt\UBL\Invoice\RO\ItemInstance[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\Certificate $certificate
     */
    public function addToCertificate(\CleverIt\UBL\Invoice\RO\Certificate $certificate)
    {
     ...
     *  Certificate
     *
     * @return \CleverIt\UBL\Invoice\RO\Certificate[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\Dimension $dimension
     */
    public function addToDimension(\CleverIt\UBL\Invoice\RO\Dimension $dimension)
    {
     ...
     *  Dimension
     *
     * @return \CleverIt\UBL\Invoice\RO\Dimension[]
     */
