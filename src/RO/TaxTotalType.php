...
class TaxTotalType
{
     ...
     *  Amount. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\RoundingAmount $roundingAmount
     */
     ...
     *  Tax Subtotal
     *
     * @var \CleverIt\UBL\Invoice\RO\TaxSubtotal[] $taxSubtotal
     */
    private $taxSubtotal = [
     ...
     *  Amount. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\RoundingAmount
     */
     ...
     *  Amount. Type
     *
     * @param \CleverIt\UBL\Invoice\RO\RoundingAmount $roundingAmount
     * @return self
     */
    public function setRoundingAmount(?\CleverIt\UBL\Invoice\RO\RoundingAmount $roundingAmount = null)
    {
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\TaxSubtotal $taxSubtotal
     */
    public function addToTaxSubtotal(\CleverIt\UBL\Invoice\RO\TaxSubtotal $taxSubtotal)
    {
     ...
     *  Tax Subtotal
     *
     * @return \CleverIt\UBL\Invoice\RO\TaxSubtotal[]
     */
