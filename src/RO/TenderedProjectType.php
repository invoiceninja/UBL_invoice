...
class TenderedProjectType
{
     ...
     *  Identifier. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\VariantID $variantID
     */
     ...
     *  Amount. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\FeeAmount $feeAmount
     */
     ...
     *  Document Reference
     *
     * @var \CleverIt\UBL\Invoice\RO\EvidenceDocumentReference[] $evidenceDocumentReference
     */
     ...
     *  Tender Line
     *
     * @var \CleverIt\UBL\Invoice\RO\TenderLine[] $tenderLine
     */
    private $tenderLine = [
     ...
     *  Awarding Criterion Response
     *
     * @var \CleverIt\UBL\Invoice\RO\AwardingCriterionResponse[] $awardingCriterionResponse
     */
     ...
     *  Identifier. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\VariantID
     */
     ...
     *  Identifier. Type
     *
     * @param \CleverIt\UBL\Invoice\RO\VariantID $variantID
     * @return self
     */
    public function setVariantID(?\CleverIt\UBL\Invoice\RO\VariantID $variantID = null)
    {
     ...
     *  Amount. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\FeeAmount
     */
     ...
     *  Amount. Type
     *
     * @param \CleverIt\UBL\Invoice\RO\FeeAmount $feeAmount
     * @return self
     */
    public function setFeeAmount(?\CleverIt\UBL\Invoice\RO\FeeAmount $feeAmount = null)
    {
     ...
     * @return self
     */
    public function setTenderEnvelopeID(?\CleverIt\UBL\Invoice\RO\TenderEnvelopeID $tenderEnvelopeID = null)
    {
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\EvidenceDocumentReference $evidenceDocumentReference
     */
    public function addToEvidenceDocumentReference(\CleverIt\UBL\Invoice\RO\EvidenceDocumentReference $evidenceDocumentReference)
    {
     ...
     *  Document Reference
     *
     * @return \CleverIt\UBL\Invoice\RO\EvidenceDocumentReference[]
     */
     ...
     * @return self
     */
    public function setLegalMonetaryTotal(?\CleverIt\UBL\Invoice\RO\LegalMonetaryTotal $legalMonetaryTotal = null)
    {
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\TenderLine $tenderLine
     */
    public function addToTenderLine(\CleverIt\UBL\Invoice\RO\TenderLine $tenderLine)
    {
     ...
     *  Tender Line
     *
     * @return \CleverIt\UBL\Invoice\RO\TenderLine[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\AwardingCriterionResponse $awardingCriterionResponse
     */
    public function addToAwardingCriterionResponse(\CleverIt\UBL\Invoice\RO\AwardingCriterionResponse $awardingCriterionResponse)
    {
     ...
     *  Awarding Criterion Response
     *
     * @return \CleverIt\UBL\Invoice\RO\AwardingCriterionResponse[]
     */
