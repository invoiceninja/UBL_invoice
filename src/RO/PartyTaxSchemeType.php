...
class PartyTaxSchemeType
{
     ...
     *
     * @var \CleverIt\UBL\Invoice\RO\RegistrationName $registrationName
     */
     ...
     *  3556625
     *
     * @var \CleverIt\UBL\Invoice\RO\CompanyID $companyID
     */
     ...
     *  Code. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\TaxLevelCode $taxLevelCode
     */
     ...
     *  Code. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\ExemptionReasonCode $exemptionReasonCode
     */
     ...
     *  Text. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\ExemptionReason[] $exemptionReason
     */
     ...
     *  Address
     *
     * @var \CleverIt\UBL\Invoice\RO\RegistrationAddress $registrationAddress
     */
     ...
     *  Microsoft Corporation
     *
     * @return \CleverIt\UBL\Invoice\RO\RegistrationName
     */
     ...
     *  Microsoft Corporation
     *
     * @param \CleverIt\UBL\Invoice\RO\RegistrationName $registrationName
     * @return self
     */
    public function setRegistrationName(?\CleverIt\UBL\Invoice\RO\RegistrationName $registrationName = null)
    {
     ...
     *  3556625
     *
     * @return \CleverIt\UBL\Invoice\RO\CompanyID
     */
     ...
     *  3556625
     *
     * @param \CleverIt\UBL\Invoice\RO\CompanyID $companyID
     * @return self
     */
    public function setCompanyID(?\CleverIt\UBL\Invoice\RO\CompanyID $companyID = null)
    {
     ...
     *  Code. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\TaxLevelCode
     */
     ...
     *  Code. Type
     *
     * @param \CleverIt\UBL\Invoice\RO\TaxLevelCode $taxLevelCode
     * @return self
     */
    public function setTaxLevelCode(?\CleverIt\UBL\Invoice\RO\TaxLevelCode $taxLevelCode = null)
    {
     ...
     *  Code. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\ExemptionReasonCode
     */
     ...
     *  Code. Type
     *
     * @param \CleverIt\UBL\Invoice\RO\ExemptionReasonCode $exemptionReasonCode
     * @return self
     */
    public function setExemptionReasonCode(?\CleverIt\UBL\Invoice\RO\ExemptionReasonCode $exemptionReasonCode = null)
    {
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\ExemptionReason $exemptionReason
     */
    public function addToExemptionReason(\CleverIt\UBL\Invoice\RO\ExemptionReason $exemptionReason)
    {
     ...
     *  Text. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\ExemptionReason[]
     */
     ...
     *  Address
     *
     * @return \CleverIt\UBL\Invoice\RO\RegistrationAddress
     */
     ...
     *  Address
     *
     * @param \CleverIt\UBL\Invoice\RO\RegistrationAddress $registrationAddress
     * @return self
     */
    public function setRegistrationAddress(?\CleverIt\UBL\Invoice\RO\RegistrationAddress $registrationAddress = null)
    {
