...
class ContractExtensionType
{
     ...
     *  Text. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\OptionsDescription[] $optionsDescription
     */
     ...
     *  Numeric. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\MinimumNumberNumeric $minimumNumberNumeric
     */
     ...
     *  Numeric. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\MaximumNumberNumeric $maximumNumberNumeric
     */
     ...
     *  Period
     *
     * @var \CleverIt\UBL\Invoice\RO\OptionValidityPeriod $optionValidityPeriod
     */
     ...
     *  Renewal
     *
     * @var \CleverIt\UBL\Invoice\RO\Renewal[] $renewal
     */
    private $renewal = [
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\OptionsDescription $optionsDescription
     */
    public function addToOptionsDescription(\CleverIt\UBL\Invoice\RO\OptionsDescription $optionsDescription)
    {
     ...
     *  Text. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\OptionsDescription[]
     */
     ...
     *  Numeric. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\MinimumNumberNumeric
     */
     ...
     *  Numeric. Type
     *
     * @param \CleverIt\UBL\Invoice\RO\MinimumNumberNumeric $minimumNumberNumeric
     * @return self
     */
    public function setMinimumNumberNumeric(?\CleverIt\UBL\Invoice\RO\MinimumNumberNumeric $minimumNumberNumeric = null)
    {
     ...
     *  Numeric. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\MaximumNumberNumeric
     */
     ...
     *  Numeric. Type
     *
     * @param \CleverIt\UBL\Invoice\RO\MaximumNumberNumeric $maximumNumberNumeric
     * @return self
     */
    public function setMaximumNumberNumeric(?\CleverIt\UBL\Invoice\RO\MaximumNumberNumeric $maximumNumberNumeric = null)
    {
     ...
     *  Period
     *
     * @return \CleverIt\UBL\Invoice\RO\OptionValidityPeriod
     */
     ...
     *  Period
     *
     * @param \CleverIt\UBL\Invoice\RO\OptionValidityPeriod $optionValidityPeriod
     * @return self
     */
    public function setOptionValidityPeriod(?\CleverIt\UBL\Invoice\RO\OptionValidityPeriod $optionValidityPeriod = null)
    {
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\Renewal $renewal
     */
    public function addToRenewal(\CleverIt\UBL\Invoice\RO\Renewal $renewal)
    {
     ...
     *  Renewal
     *
     * @return \CleverIt\UBL\Invoice\RO\Renewal[]
     */
