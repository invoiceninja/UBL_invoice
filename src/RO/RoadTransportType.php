...
class RoadTransportType
{
     ...
     *
     * @var \CleverIt\UBL\Invoice\RO\LicensePlateID $licensePlateID
     */
     ...
     *  Vehicle registration number (WCO ID 167)
     *
     * @return \CleverIt\UBL\Invoice\RO\LicensePlateID
     */
     ...
     *  Vehicle registration number (WCO ID 167)
     *
     * @param \CleverIt\UBL\Invoice\RO\LicensePlateID $licensePlateID
     * @return self
     */
    public function setLicensePlateID(\CleverIt\UBL\Invoice\RO\LicensePlateID $licensePlateID)
    {
