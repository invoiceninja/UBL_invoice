...
class RailTransportType
{
     ...
     *
     * @var \CleverIt\UBL\Invoice\RO\TrainID $trainID
     */
     ...
     *  Identifier. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\RailCarID $railCarID
     */
     ...
     *  Train Number (WCO ID 167)
     *
     * @return \CleverIt\UBL\Invoice\RO\TrainID
     */
     ...
     *  Train Number (WCO ID 167)
     *
     * @param \CleverIt\UBL\Invoice\RO\TrainID $trainID
     * @return self
     */
    public function setTrainID(\CleverIt\UBL\Invoice\RO\TrainID $trainID)
    {
     ...
     *  Identifier. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\RailCarID
     */
     ...
     *  Identifier. Type
     *
     * @param \CleverIt\UBL\Invoice\RO\RailCarID $railCarID
     * @return self
     */
    public function setRailCarID(?\CleverIt\UBL\Invoice\RO\RailCarID $railCarID = null)
    {
