...
class TransportationServiceType
{
     ...
     *  Code. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\TransportServiceCode $transportServiceCode
     */
     ...
     *
     * @var \CleverIt\UBL\Invoice\RO\TariffClassCode $tariffClassCode
     */
     ...
     *  Text. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\Priority $priority
     */
     ...
     *  Charge Basis
     *
     * @var \CleverIt\UBL\Invoice\RO\FreightRateClassCode $freightRateClassCode
     */
     ...
     *  Text. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\TransportationServiceDescription[] $transportationServiceDescription
     */
     ...
     *  Identifier. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\TransportationServiceDetailsURI $transportationServiceDetailsURI
     */
     ...
     *  Transport Equipment
     *
     * @var \CleverIt\UBL\Invoice\RO\SupportedTransportEquipment[] $supportedTransportEquipment
     */
     ...
     *  Transport Equipment
     *
     * @var \CleverIt\UBL\Invoice\RO\UnsupportedTransportEquipment[] $unsupportedTransportEquipment
     */
     ...
     *  Commodity Classification
     *
     * @var \CleverIt\UBL\Invoice\RO\SupportedCommodityClassification[] $supportedCommodityClassification
     */
     ...
     *  Commodity Classification
     *
     * @var \CleverIt\UBL\Invoice\RO\UnsupportedCommodityClassification[] $unsupportedCommodityClassification
     */
     ...
     *  Dimension
     *
     * @var \CleverIt\UBL\Invoice\RO\TotalCapacityDimension $totalCapacityDimension
     */
     ...
     *  Shipment Stage
     *
     * @var \CleverIt\UBL\Invoice\RO\ShipmentStage[] $shipmentStage
     */
     ...
     *  Party
     *
     * @var \CleverIt\UBL\Invoice\RO\ResponsibleTransportServiceProviderParty $responsibleTransportServiceProviderParty
     */
     ...
     *  Period
     *
     * @var \CleverIt\UBL\Invoice\RO\EstimatedDurationPeriod $estimatedDurationPeriod
     */
     ...
     *  Service Frequency
     *
     * @var \CleverIt\UBL\Invoice\RO\ScheduledServiceFrequency[] $scheduledServiceFrequency
     */
     ...
     *  Code. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\TransportServiceCode
     */
     ...
     *  Code. Type
     *
     * @param \CleverIt\UBL\Invoice\RO\TransportServiceCode $transportServiceCode
     * @return self
     */
    public function setTransportServiceCode(\CleverIt\UBL\Invoice\RO\TransportServiceCode $transportServiceCode)
    {
     ...
     *  Tariff Class Specifier
     *
     * @return \CleverIt\UBL\Invoice\RO\TariffClassCode
     */
     ...
     *  Tariff Class Specifier
     *
     * @param \CleverIt\UBL\Invoice\RO\TariffClassCode $tariffClassCode
     * @return self
     */
    public function setTariffClassCode(?\CleverIt\UBL\Invoice\RO\TariffClassCode $tariffClassCode = null)
    {
     ...
     *  Text. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\Priority
     */
     ...
     *  Text. Type
     *
     * @param \CleverIt\UBL\Invoice\RO\Priority $priority
     * @return self
     */
    public function setPriority(?\CleverIt\UBL\Invoice\RO\Priority $priority = null)
    {
     ...
     *  Charge Basis
     *
     * @return \CleverIt\UBL\Invoice\RO\FreightRateClassCode
     */
     ...
     *  Charge Basis
     *
     * @param \CleverIt\UBL\Invoice\RO\FreightRateClassCode $freightRateClassCode
     * @return self
     */
    public function setFreightRateClassCode(?\CleverIt\UBL\Invoice\RO\FreightRateClassCode $freightRateClassCode = null)
    {
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\TransportationServiceDescription $transportationServiceDescription
     */
    public function addToTransportationServiceDescription(\CleverIt\UBL\Invoice\RO\TransportationServiceDescription $transportationServiceDescription)
    {
     ...
     *  Text. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\TransportationServiceDescription[]
     */
     ...
     *  Identifier. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\TransportationServiceDetailsURI
     */
     ...
     *  Identifier. Type
     *
     * @param \CleverIt\UBL\Invoice\RO\TransportationServiceDetailsURI $transportationServiceDetailsURI
     * @return self
     */
    public function setTransportationServiceDetailsURI(?\CleverIt\UBL\Invoice\RO\TransportationServiceDetailsURI $transportationServiceDetailsURI = null)
    {
     ...
     * @return self
     */
    public function setSequenceNumeric(?\CleverIt\UBL\Invoice\RO\SequenceNumeric $sequenceNumeric = null)
    {
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\SupportedTransportEquipment $supportedTransportEquipment
     */
    public function addToSupportedTransportEquipment(\CleverIt\UBL\Invoice\RO\SupportedTransportEquipment $supportedTransportEquipment)
    {
     ...
     *  Transport Equipment
     *
     * @return \CleverIt\UBL\Invoice\RO\SupportedTransportEquipment[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\UnsupportedTransportEquipment $unsupportedTransportEquipment
     */
    public function addToUnsupportedTransportEquipment(\CleverIt\UBL\Invoice\RO\UnsupportedTransportEquipment $unsupportedTransportEquipment)
    {
     ...
     *  Transport Equipment
     *
     * @return \CleverIt\UBL\Invoice\RO\UnsupportedTransportEquipment[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\SupportedCommodityClassification $supportedCommodityClassification
     */
    public function addToSupportedCommodityClassification(\CleverIt\UBL\Invoice\RO\SupportedCommodityClassification $supportedCommodityClassification)
    {
     ...
     *  Commodity Classification
     *
     * @return \CleverIt\UBL\Invoice\RO\SupportedCommodityClassification[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\UnsupportedCommodityClassification $unsupportedCommodityClassification
     */
    public function addToUnsupportedCommodityClassification(\CleverIt\UBL\Invoice\RO\UnsupportedCommodityClassification $unsupportedCommodityClassification)
    {
     ...
     *  Commodity Classification
     *
     * @return \CleverIt\UBL\Invoice\RO\UnsupportedCommodityClassification[]
     */
     ...
     *  Dimension
     *
     * @return \CleverIt\UBL\Invoice\RO\TotalCapacityDimension
     */
     ...
     *  Dimension
     *
     * @param \CleverIt\UBL\Invoice\RO\TotalCapacityDimension $totalCapacityDimension
     * @return self
     */
    public function setTotalCapacityDimension(?\CleverIt\UBL\Invoice\RO\TotalCapacityDimension $totalCapacityDimension = null)
    {
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\ShipmentStage $shipmentStage
     */
    public function addToShipmentStage(\CleverIt\UBL\Invoice\RO\ShipmentStage $shipmentStage)
    {
     ...
     *  Shipment Stage
     *
     * @return \CleverIt\UBL\Invoice\RO\ShipmentStage[]
     */
     ...
     *  Party
     *
     * @return \CleverIt\UBL\Invoice\RO\ResponsibleTransportServiceProviderParty
     */
     ...
     *  Party
     *
     * @param \CleverIt\UBL\Invoice\RO\ResponsibleTransportServiceProviderParty $responsibleTransportServiceProviderParty
     * @return self
     */
    public function setResponsibleTransportServiceProviderParty(?\CleverIt\UBL\Invoice\RO\ResponsibleTransportServiceProviderParty $responsibleTransportServiceProviderParty = null)
    {
     ...
     *  Period
     *
     * @return \CleverIt\UBL\Invoice\RO\EstimatedDurationPeriod
     */
     ...
     *  Period
     *
     * @param \CleverIt\UBL\Invoice\RO\EstimatedDurationPeriod $estimatedDurationPeriod
     * @return self
     */
    public function setEstimatedDurationPeriod(?\CleverIt\UBL\Invoice\RO\EstimatedDurationPeriod $estimatedDurationPeriod = null)
    {
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\ScheduledServiceFrequency $scheduledServiceFrequency
     */
    public function addToScheduledServiceFrequency(\CleverIt\UBL\Invoice\RO\ScheduledServiceFrequency $scheduledServiceFrequency)
    {
     ...
     *  Service Frequency
     *
     * @return \CleverIt\UBL\Invoice\RO\ScheduledServiceFrequency[]
     */
