...
class TransportEquipmentType
{
     ...
     *  Identifier. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\ReferencedConsignmentID[] $referencedConsignmentID
     */
     ...
     *
     * @var \CleverIt\UBL\Invoice\RO\TransportEquipmentTypeCode $transportEquipmentTypeCode
     */
     ...
     *  Code. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\ProviderTypeCode $providerTypeCode
     */
     ...
     *  Code. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\OwnerTypeCode $ownerTypeCode
     */
     ...
     *
     * @var \CleverIt\UBL\Invoice\RO\SizeTypeCode $sizeTypeCode
     */
     ...
     *  Status
     *
     * @var \CleverIt\UBL\Invoice\RO\DispositionCode $dispositionCode
     */
     ...
     *  Percent. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\AirFlowPercent $airFlowPercent
     */
     ...
     *  Percent. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\HumidityPercent $humidityPercent
     */
     ...
     *  Text. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\Characteristics $characteristics
     */
     ...
     *  Text. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\SpecialTransportRequirements[] $specialTransportRequirements
     */
     ...
     *  Measure. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\TareWeightMeasure $tareWeightMeasure
     */
     ...
     *  Code. Type
     *
     * @var \CleverIt\UBL\Invoice\RO\TrackingDeviceCode $trackingDeviceCode
     */
     ...
     *  Transport Equipment Seal
     *
     * @var \CleverIt\UBL\Invoice\RO\TransportEquipmentSeal[] $transportEquipmentSeal
     */
     ...
     *  Party
     *
     * @var \CleverIt\UBL\Invoice\RO\ProviderParty $providerParty
     */
     ...
     *
     * @var \CleverIt\UBL\Invoice\RO\LoadingProofParty $loadingProofParty
     */
     ...
     *  Party responsible for proof of vanning (WCO ID 059)
     *
     * @var \CleverIt\UBL\Invoice\RO\SupplierParty $supplierParty
     */
     ...
     *  Party responsible for proof of vanning (WCO ID 059)
     *
     * @var \CleverIt\UBL\Invoice\RO\OperatingParty $operatingParty
     */
     ...
     *
     * @var \CleverIt\UBL\Invoice\RO\LoadingLocation $loadingLocation
     */
     ...
     *  Location
     *
     * @var \CleverIt\UBL\Invoice\RO\UnloadingLocation $unloadingLocation
     */
     ...
     *  Location
     *
     * @var \CleverIt\UBL\Invoice\RO\StorageLocation $storageLocation
     */
     ...
     *  Transport Event
     *
     * @var \CleverIt\UBL\Invoice\RO\PositioningTransportEvent[] $positioningTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \CleverIt\UBL\Invoice\RO\QuarantineTransportEvent[] $quarantineTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \CleverIt\UBL\Invoice\RO\DeliveryTransportEvent[] $deliveryTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \CleverIt\UBL\Invoice\RO\PickupTransportEvent[] $pickupTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \CleverIt\UBL\Invoice\RO\HandlingTransportEvent[] $handlingTransportEvent
     */
     ...
     *  Transport Event
     *
     * @var \CleverIt\UBL\Invoice\RO\LoadingTransportEvent[] $loadingTransportEvent
     */
     ...
     *  Transport Means
     *
     * @var \CleverIt\UBL\Invoice\RO\ApplicableTransportMeans $applicableTransportMeans
     */
     ...
     *  Trading Terms
     *
     * @var \CleverIt\UBL\Invoice\RO\HaulageTradingTerms[] $haulageTradingTerms
     */
     ...
     *  Transport Handling Unit
     *
     * @var \CleverIt\UBL\Invoice\RO\PackagedTransportHandlingUnit[] $packagedTransportHandlingUnit
     */
     ...
     *  Allowance Charge
     *
     * @var \CleverIt\UBL\Invoice\RO\ServiceAllowanceCharge[] $serviceAllowanceCharge
     */
     ...
     *  Transport Equipment
     *
     * @var \CleverIt\UBL\Invoice\RO\AttachedTransportEquipment[] $attachedTransportEquipment
     */
     ...
     *
     * @var \CleverIt\UBL\Invoice\RO\ContainedInTransportEquipment[] $containedInTransportEquipment
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\ReferencedConsignmentID $referencedConsignmentID
     */
    public function addToReferencedConsignmentID(\CleverIt\UBL\Invoice\RO\ReferencedConsignmentID $referencedConsignmentID)
    {
     ...
     *  Identifier. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\ReferencedConsignmentID[]
     */
     ...
     *  Transport Equipment Type_ Code. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\TransportEquipmentTypeCode
     */
     ...
     *  Transport Equipment Type_ Code. Type
     *
     * @param \CleverIt\UBL\Invoice\RO\TransportEquipmentTypeCode $transportEquipmentTypeCode
     * @return self
     */
    public function setTransportEquipmentTypeCode(?\CleverIt\UBL\Invoice\RO\TransportEquipmentTypeCode $transportEquipmentTypeCode = null)
    {
     ...
     *  Code. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\ProviderTypeCode
     */
     ...
     *  Code. Type
     *
     * @param \CleverIt\UBL\Invoice\RO\ProviderTypeCode $providerTypeCode
     * @return self
     */
    public function setProviderTypeCode(?\CleverIt\UBL\Invoice\RO\ProviderTypeCode $providerTypeCode = null)
    {
     ...
     *  Code. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\OwnerTypeCode
     */
     ...
     *  Code. Type
     *
     * @param \CleverIt\UBL\Invoice\RO\OwnerTypeCode $ownerTypeCode
     * @return self
     */
    public function setOwnerTypeCode(?\CleverIt\UBL\Invoice\RO\OwnerTypeCode $ownerTypeCode = null)
    {
     ...
     *  Container Size Type Code
     *
     * @return \CleverIt\UBL\Invoice\RO\SizeTypeCode
     */
     ...
     *  Container Size Type Code
     *
     * @param \CleverIt\UBL\Invoice\RO\SizeTypeCode $sizeTypeCode
     * @return self
     */
    public function setSizeTypeCode(?\CleverIt\UBL\Invoice\RO\SizeTypeCode $sizeTypeCode = null)
    {
     ...
     *  Status
     *
     * @return \CleverIt\UBL\Invoice\RO\DispositionCode
     */
     ...
     *  Status
     *
     * @param \CleverIt\UBL\Invoice\RO\DispositionCode $dispositionCode
     * @return self
     */
    public function setDispositionCode(?\CleverIt\UBL\Invoice\RO\DispositionCode $dispositionCode = null)
    {
     ...
     *  Percent. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\AirFlowPercent
     */
     ...
     *  Percent. Type
     *
     * @param \CleverIt\UBL\Invoice\RO\AirFlowPercent $airFlowPercent
     * @return self
     */
    public function setAirFlowPercent(?\CleverIt\UBL\Invoice\RO\AirFlowPercent $airFlowPercent = null)
    {
     ...
     *  Percent. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\HumidityPercent
     */
     ...
     *  Percent. Type
     *
     * @param \CleverIt\UBL\Invoice\RO\HumidityPercent $humidityPercent
     * @return self
     */
    public function setHumidityPercent(?\CleverIt\UBL\Invoice\RO\HumidityPercent $humidityPercent = null)
    {
     ...
     *  Text. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\Characteristics
     */
     ...
     *  Text. Type
     *
     * @param \CleverIt\UBL\Invoice\RO\Characteristics $characteristics
     * @return self
     */
    public function setCharacteristics(?\CleverIt\UBL\Invoice\RO\Characteristics $characteristics = null)
    {
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\SpecialTransportRequirements $specialTransportRequirements
     */
    public function addToSpecialTransportRequirements(\CleverIt\UBL\Invoice\RO\SpecialTransportRequirements $specialTransportRequirements)
    {
     ...
     *  Text. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\SpecialTransportRequirements[]
     */
     ...
     *  Measure. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\TareWeightMeasure
     */
     ...
     *  Measure. Type
     *
     * @param \CleverIt\UBL\Invoice\RO\TareWeightMeasure $tareWeightMeasure
     * @return self
     */
    public function setTareWeightMeasure(?\CleverIt\UBL\Invoice\RO\TareWeightMeasure $tareWeightMeasure = null)
    {
     ...
     *  Code. Type
     *
     * @return \CleverIt\UBL\Invoice\RO\TrackingDeviceCode
     */
     ...
     *  Code. Type
     *
     * @param \CleverIt\UBL\Invoice\RO\TrackingDeviceCode $trackingDeviceCode
     * @return self
     */
    public function setTrackingDeviceCode(?\CleverIt\UBL\Invoice\RO\TrackingDeviceCode $trackingDeviceCode = null)
    {
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\TransportEquipmentSeal $transportEquipmentSeal
     */
    public function addToTransportEquipmentSeal(\CleverIt\UBL\Invoice\RO\TransportEquipmentSeal $transportEquipmentSeal)
    {
     ...
     *  Transport Equipment Seal
     *
     * @return \CleverIt\UBL\Invoice\RO\TransportEquipmentSeal[]
     */
     ...
     *  Party
     *
     * @return \CleverIt\UBL\Invoice\RO\ProviderParty
     */
     ...
     *  Party
     *
     * @param \CleverIt\UBL\Invoice\RO\ProviderParty $providerParty
     * @return self
     */
    public function setProviderParty(?\CleverIt\UBL\Invoice\RO\ProviderParty $providerParty = null)
    {
     ...
     *  Party responsible for proof of vanning (WCO ID 059)
     *
     * @return \CleverIt\UBL\Invoice\RO\LoadingProofParty
     */
     ...
     *  Party responsible for proof of vanning (WCO ID 059)
     *
     * @param \CleverIt\UBL\Invoice\RO\LoadingProofParty $loadingProofParty
     * @return self
     */
    public function setLoadingProofParty(?\CleverIt\UBL\Invoice\RO\LoadingProofParty $loadingProofParty = null)
    {
     ...
     *  Party responsible for proof of vanning (WCO ID 059)
     *
     * @return \CleverIt\UBL\Invoice\RO\SupplierParty
     */
     ...
     *  Party responsible for proof of vanning (WCO ID 059)
     *
     * @param \CleverIt\UBL\Invoice\RO\SupplierParty $supplierParty
     * @return self
     */
    public function setSupplierParty(?\CleverIt\UBL\Invoice\RO\SupplierParty $supplierParty = null)
    {
     ...
     *  Party responsible for proof of vanning (WCO ID 059)
     *
     * @return \CleverIt\UBL\Invoice\RO\OperatingParty
     */
     ...
     *  Party responsible for proof of vanning (WCO ID 059)
     *
     * @param \CleverIt\UBL\Invoice\RO\OperatingParty $operatingParty
     * @return self
     */
    public function setOperatingParty(?\CleverIt\UBL\Invoice\RO\OperatingParty $operatingParty = null)
    {
     ...
     *  Vanning address (WCO ID 068), Stuffing location
     *
     * @return \CleverIt\UBL\Invoice\RO\LoadingLocation
     */
     ...
     *  Vanning address (WCO ID 068), Stuffing location
     *
     * @param \CleverIt\UBL\Invoice\RO\LoadingLocation $loadingLocation
     * @return self
     */
    public function setLoadingLocation(?\CleverIt\UBL\Invoice\RO\LoadingLocation $loadingLocation = null)
    {
     ...
     *  Location
     *
     * @return \CleverIt\UBL\Invoice\RO\UnloadingLocation
     */
     ...
     *  Location
     *
     * @param \CleverIt\UBL\Invoice\RO\UnloadingLocation $unloadingLocation
     * @return self
     */
    public function setUnloadingLocation(?\CleverIt\UBL\Invoice\RO\UnloadingLocation $unloadingLocation = null)
    {
     ...
     *  Location
     *
     * @return \CleverIt\UBL\Invoice\RO\StorageLocation
     */
     ...
     *  Location
     *
     * @param \CleverIt\UBL\Invoice\RO\StorageLocation $storageLocation
     * @return self
     */
    public function setStorageLocation(?\CleverIt\UBL\Invoice\RO\StorageLocation $storageLocation = null)
    {
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\PositioningTransportEvent $positioningTransportEvent
     */
    public function addToPositioningTransportEvent(\CleverIt\UBL\Invoice\RO\PositioningTransportEvent $positioningTransportEvent)
    {
     ...
     *  Transport Event
     *
     * @return \CleverIt\UBL\Invoice\RO\PositioningTransportEvent[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\QuarantineTransportEvent $quarantineTransportEvent
     */
    public function addToQuarantineTransportEvent(\CleverIt\UBL\Invoice\RO\QuarantineTransportEvent $quarantineTransportEvent)
    {
     ...
     *  Transport Event
     *
     * @return \CleverIt\UBL\Invoice\RO\QuarantineTransportEvent[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\DeliveryTransportEvent $deliveryTransportEvent
     */
    public function addToDeliveryTransportEvent(\CleverIt\UBL\Invoice\RO\DeliveryTransportEvent $deliveryTransportEvent)
    {
     ...
     *  Transport Event
     *
     * @return \CleverIt\UBL\Invoice\RO\DeliveryTransportEvent[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\PickupTransportEvent $pickupTransportEvent
     */
    public function addToPickupTransportEvent(\CleverIt\UBL\Invoice\RO\PickupTransportEvent $pickupTransportEvent)
    {
     ...
     *  Transport Event
     *
     * @return \CleverIt\UBL\Invoice\RO\PickupTransportEvent[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\HandlingTransportEvent $handlingTransportEvent
     */
    public function addToHandlingTransportEvent(\CleverIt\UBL\Invoice\RO\HandlingTransportEvent $handlingTransportEvent)
    {
     ...
     *  Transport Event
     *
     * @return \CleverIt\UBL\Invoice\RO\HandlingTransportEvent[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\LoadingTransportEvent $loadingTransportEvent
     */
    public function addToLoadingTransportEvent(\CleverIt\UBL\Invoice\RO\LoadingTransportEvent $loadingTransportEvent)
    {
     ...
     *  Transport Event
     *
     * @return \CleverIt\UBL\Invoice\RO\LoadingTransportEvent[]
     */
     ...
     *  Transport Means
     *
     * @return \CleverIt\UBL\Invoice\RO\ApplicableTransportMeans
     */
     ...
     *  Transport Means
     *
     * @param \CleverIt\UBL\Invoice\RO\ApplicableTransportMeans $applicableTransportMeans
     * @return self
     */
    public function setApplicableTransportMeans(?\CleverIt\UBL\Invoice\RO\ApplicableTransportMeans $applicableTransportMeans = null)
    {
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\HaulageTradingTerms $haulageTradingTerms
     */
    public function addToHaulageTradingTerms(\CleverIt\UBL\Invoice\RO\HaulageTradingTerms $haulageTradingTerms)
    {
     ...
     *  Trading Terms
     *
     * @return \CleverIt\UBL\Invoice\RO\HaulageTradingTerms[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\PackagedTransportHandlingUnit $packagedTransportHandlingUnit
     */
    public function addToPackagedTransportHandlingUnit(\CleverIt\UBL\Invoice\RO\PackagedTransportHandlingUnit $packagedTransportHandlingUnit)
    {
     ...
     *  Transport Handling Unit
     *
     * @return \CleverIt\UBL\Invoice\RO\PackagedTransportHandlingUnit[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\ServiceAllowanceCharge $serviceAllowanceCharge
     */
    public function addToServiceAllowanceCharge(\CleverIt\UBL\Invoice\RO\ServiceAllowanceCharge $serviceAllowanceCharge)
    {
     ...
     *  Allowance Charge
     *
     * @return \CleverIt\UBL\Invoice\RO\ServiceAllowanceCharge[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\AttachedTransportEquipment $attachedTransportEquipment
     */
    public function addToAttachedTransportEquipment(\CleverIt\UBL\Invoice\RO\AttachedTransportEquipment $attachedTransportEquipment)
    {
     ...
     *  Transport Equipment
     *
     * @return \CleverIt\UBL\Invoice\RO\AttachedTransportEquipment[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\RO\ContainedInTransportEquipment $containedInTransportEquipment
     */
    public function addToContainedInTransportEquipment(\CleverIt\UBL\Invoice\RO\ContainedInTransportEquipment $containedInTransportEquipment)
    {
     ...
     *  e.g. pallets inside containers
     *
     * @return \CleverIt\UBL\Invoice\RO\ContainedInTransportEquipment[]
     */
