...
class CreditNoteLineType
{
     ...
     *  Quantity. Type
     *
     * @var \CleverIt\UBL\Invoice\CreditedQuantity $creditedQuantity
     */
     ...
     *  Response
     *
     * @var \CleverIt\UBL\Invoice\DiscrepancyResponse[] $discrepancyResponse
     */
     ...
     *  Credit Note Line
     *
     * @var \CleverIt\UBL\Invoice\SubCreditNoteLine[] $subCreditNoteLine
     */
     ...
     *  Quantity. Type
     *
     * @return \CleverIt\UBL\Invoice\CreditedQuantity
     */
     ...
     *  Quantity. Type
     *
     * @param \CleverIt\UBL\Invoice\CreditedQuantity $creditedQuantity
     * @return self
     */
    public function setCreditedQuantity(\CleverIt\UBL\Invoice\CreditedQuantity $creditedQuantity)
    {
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\DiscrepancyResponse $discrepancyResponse
     */
    public function addToDiscrepancyResponse(\CleverIt\UBL\Invoice\DiscrepancyResponse $discrepancyResponse)
    {
     ...
     *  Response
     *
     * @return \CleverIt\UBL\Invoice\DiscrepancyResponse[]
     */
     ...
     *
     * @return self
     * @param \CleverIt\UBL\Invoice\SubCreditNoteLine $subCreditNoteLine
     */
    public function addToSubCreditNoteLine(\CleverIt\UBL\Invoice\SubCreditNoteLine $subCreditNoteLine)
    {
     ...
     *  Credit Note Line
     *
     * @return \CleverIt\UBL\Invoice\SubCreditNoteLine[]
     */
